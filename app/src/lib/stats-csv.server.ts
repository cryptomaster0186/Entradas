// Server-only: reads stats.csv from disk. Never import this in a client component.
import * as fs from "fs";
import * as path from "path";
import type { StatsRow, AccountSummary } from "./stats-csv";

export type { StatsRow, AccountSummary };
